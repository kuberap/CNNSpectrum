...
BEST_MODEL_PATH = "best_model_co_cs_eu_th_u_am_cocs_classification.pth"
TRAIN_DATA_RESULTS = "best_model_co_cs_eu_th_u_am_cocs_classification_train.csv"
TEST_DATA_RESULTS = "best_model_co_cs_eu_th_u_am_cocs_  classification_test.csv"
