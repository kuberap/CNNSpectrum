...
BEST_MODEL_PATH = "best_model_bg_co_cs_classification.pth"
TRAIN_DATA_RESULTS = "best_model_bg_co_cs_classification_train.csv"
TEST_DATA_RESULTS = "best_model_bg_co_cs_classification_test.csv"
